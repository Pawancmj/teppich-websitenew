...
// ... import all other sample images similarly for sample1, sample2, sample3
...
export const sampleCollection = {
  1: [
    sample1_1,sample1_2, sample1_3, sample1_4, sample1_5,
      ...
      sample1_16, sample1_17, sample1_18, sample1_19, sample1_20, /* rest of sample1 images */ 
  ],
  2: [
    sample2_1, sample2_2, sample2_3, sample2_4, sample2_5,
      ...
      sample2_36, /* rest of sample2 images */
  ],
  3: [
    sample3_1,sample3_2, sample3_3, sample3_4, sample3_5,
      ...
      sample3_21, sample3_22, sample3_23, /* rest of sample3 images */
  ],
};
...
export const sampleData = {
  1: {
    ...
    slogan: "The loom is silent, the heart is loud, Each tuft a whisper, soft and proud.",
  },
  2: {
...
export const initialCollection = Object.entries(sampleCollection).map(([id, images]) => ({
  id,
  title: sampleData[id]?.title || "",
  slogan: sampleData[id]?.slogan || "",
  images,
}));
